 ...
 */
public class StackOverflowApiJsonQueryTest extends StackOverflowApiClientTest {
	
	/** The client. */
	private StackOverflowApiQueryFactory queryFactory;
	...
	public void setUp() throws Exception {
		super.setUp();
		queryFactory = StackOverflowApiQueryFactory.newInstance(TestConstants.STACK_OVERFLOW_TEST_API_KEY);
	}
