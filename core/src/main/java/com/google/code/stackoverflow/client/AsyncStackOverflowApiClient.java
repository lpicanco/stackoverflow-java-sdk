...
public interface AsyncStackOverflowApiClient extends StackOverflowAuthenticationClient {
	...
	public Future<List<Question>> getQuestions(QuestionSortOrder sort);
	public Future<List<Question>> getQuestions(Set<FilterOption> filterOptions);
	public Future<List<Question>> getQuestions(QuestionSortOrder sort, Paging paging, TimePeriod timePeriod, Set<FilterOption> filterOptions);
	public Future<List<Question>> getUnansweredQuestions();
	public Future<List<Question>> getUnansweredQuestions(UnansweredQuestionSortOrder sort);
	...
	public Future<List<Question>> getUnansweredQuestions(UnansweredQuestionSortOrder sort, Paging paging, TimePeriod timePeriod, Set<FilterOption> filterOptions);
	...
	public Future<List<Question>> getQuestionsByUser(long userId, UserQuestionSortOrder sort);
	...
	public Future<List<Question>> getQuestionsByUser(long userId, UserQuestionSortOrder sort, Paging paging, TimePeriod timePeriod, Set<FilterOption> filterOptions);
	public Future<List<Question>> getFavoriteQuestionsByUser(long userId);
	public Future<List<Question>> getFavoriteQuestionsByUser(long userId, UserFavoriteSortOrder sort);
	...
	public Future<List<Question>> getFavoriteQuestionsByUser(long userId, UserFavoriteSortOrder sort, Paging paging, TimePeriod timePeriod, Set<FilterOption> filterOptions);
	...
	public Future<List<User>> getUsers(UserSortOrder sort);
	public Future<List<User>> getUsers(String filter, UserSortOrder sort, Paging paging);
	...
	public Future<List<Tag>> getTags(TagSortOrder sort);
	public Future<List<Tag>> getTags(Paging paging);
	public Future<List<Tag>> getTags(TagSortOrder sort, Paging paging);
	...
	public Future<List<Answer>> getAnswersByUser(long userId, AnswerSortOrder sort);
	public Future<List<Answer>> getAnswersByUser(long userId, AnswerSortOrder sort, Set<FilterOption> filterOptions);
	...
	public Future<List<Comment>> getUserComments(long userId, CommentSortOrder sort);
	...
	public Future<List<Comment>> getUserComments(long userId, CommentSortOrder sort, Paging paging, TimePeriod timePeriod);

	public Future<List<Comment>> getUserComments(long userId, long toUserId);
	public Future<List<Comment>> getUserComments(long userId, long toUserId, CommentSortOrder sort);
	...
	public Future<List<Comment>> getUserComments(long userId, long toUserId, CommentSortOrder sort, Paging paging, TimePeriod timePeriod);
