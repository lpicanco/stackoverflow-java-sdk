...
public class ApiVersionImpl extends BaseJsonAdapter implements ApiVersion, Adaptable<ApiVersion, JSONObject> {
	...
	/* (non-Javadoc)
	 * @see com.google.code.stackoverflow.schema.ApiVersion#getVersion()
	 */
	...
	/* (non-Javadoc)
	 * @see com.google.code.stackoverflow.schema.ApiVersion#setVersion(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.google.code.stackoverflow.schema.ApiVersion#getRevision()
	 */
	...
	/* (non-Javadoc)
	 * @see com.google.code.stackoverflow.schema.ApiVersion#setRevision(java.lang.String)
	 */
