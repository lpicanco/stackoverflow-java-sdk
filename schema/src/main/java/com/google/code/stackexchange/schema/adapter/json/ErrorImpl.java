...
public class ErrorImpl extends BaseJsonAdapter implements Error, Adaptable<Error, JSONObject> {
	...
	/* (non-Javadoc)
	 * @see com.google.code.stackexchange.schema.Error#getErrorCode()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.google.code.stackexchange.schema.Error#getMessage()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.google.code.stackexchange.schema.Error#getTimestamp()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.google.code.stackexchange.schema.Error#setErrorCode(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.google.code.stackexchange.schema.Error#setMessage(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.google.code.stackexchange.schema.Error#setTimestamp(java.util.Date)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.google.code.stackexchange.schema.Error#getStatusCode()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.google.code.stackexchange.schema.Error#setStatusCode(int)
	 */
	@Override
